package com.latihan.resepdunia;
...
import com.latihan.resepdunia.databinding.ItemLayoutBinding;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.GridViewHolder> {
    ...
    public void onBindViewHolder(@NonNull GridViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(viewContext, DetailActivity.class);
            intent.putExtra("i_idMeal", currentMeal.getIdMeal());
